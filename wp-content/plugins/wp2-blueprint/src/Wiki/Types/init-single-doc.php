<?php
// Path: wp-content/plugins/wp2-blueprint/src/Wiki/Types/init-single-doc.php
...
class DocController
{
    ...
    private function set_args()
    {
        ...
        $args = [
            ...
            'has_archive'        => 'wp2-wiki',
            'hierarchical'       => true,
            'menu_position'      => null,
            'supports'           => ['title', 'editor', 'author', 'thumbnail', 'excerpt', 'comments', 'page-attributes', 'custom-fields', 'revisions'],
            'show_in_rest'       => true,
        ];
