<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Assets/init.php

namespace WP2_Directory\Syncs\Listings\Assets;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_assets_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_assets_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Assets';
 ...
 */
function wp2_directory_execute_assets_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_assets_sync', __NAMESPACE__ . '\\wp2_directory_execute_assets_sync');
