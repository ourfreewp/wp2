<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Flows/init.php

namespace WP2_Directory\Syncs\Listings\Flows;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_flows_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_flows_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Flows';
 ...
 */
function wp2_directory_execute_flows_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_flows_sync', __NAMESPACE__ . '\\wp2_directory_execute_flows_sync');
