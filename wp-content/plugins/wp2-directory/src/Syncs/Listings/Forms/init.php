<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Forms/init.php

namespace WP2_Directory\Syncs\Listings\Forms;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_forms_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_forms_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Forms';
 ...
 */
function wp2_directory_execute_forms_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_forms_sync', __NAMESPACE__ . '\\wp2_directory_execute_forms_sync');
