<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Modules/init.php

namespace WP2_Directory\Syncs\Listings\Modules;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_modules_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_modules_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Modules';
    ...
    public function handle_sync(): void
    {
        if ($this->check_context()) {
            ...
            $admin_notice = [
                'type'            => 'info',
                'message'         => 'Syncing Module Listings...',
                'is_dismissible'  => true,
 ...
 */
function wp2_directory_execute_modules_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_modules_sync', __NAMESPACE__ . '\\wp2_directory_execute_modules_sync');
