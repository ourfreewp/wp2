<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Pages/init.php

namespace WP2_Directory\Syncs\Listings\Pages;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_pages_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_pages_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Pages';
...
// Instantiate the page sync controller.
new Controller();

/**
 * Scheduled callback function for page sync.
 *
 * This function is hooked to the async action.
 */
function wp2_directory_execute_pages_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_pages_sync', __NAMESPACE__ . '\\wp2_directory_execute_pages_sync');
