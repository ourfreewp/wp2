<?php
// Path: wp-content/plugins/wp2/src/Blocks/QueriedItemMeta/index.php
...
<div class="wp2-meta wp2-meta--<?php echo esc_attr($type); ?> wp2-meta--<?php echo esc_attr($context); ?>" useBlockProps>
    <?php echo $content; ?>
</div>