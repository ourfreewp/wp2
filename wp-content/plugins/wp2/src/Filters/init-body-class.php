<?php
// Path: wp-content/plugins/wp2/src/Filters/init-body-class.php
namespace WP2\Filters;

use WP2\Helpers\ContextController;

/**
 * Manages body classes and related functionalities.
 */
 ...
 * Initialize the body class controller.
 */
function wp2_init_body_class_controller()
{
    new BodyClassController();
}

add_action('init', function () {
    wp2_init_body_class_controller();
}, 20);