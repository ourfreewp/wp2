...
class TemplatePartController
{
    ...
    private function generate_part_content($template, $template_zone)
    {
        ...
        $template_map = [
            'root-header'      => '<!-- wp:wp2/site-header %s --><!-- /wp:wp2/site-header -->',
            'root-content'     => '<!-- wp:wp2/site-content %s --><!-- /wp:wp2/site-content -->',
            'root-footer'      => '<!-- wp:wp2/site-footer %s --><!-- /wp:wp2/site-footer -->',
