<?php
// Path: wp-content/plugins/wp2/src/Themes/Templates/init.php

namespace WP2\Themes\Templates;
 ...
 */
function wp2_init_themes_templates_controller()
{
    new Controller();
}

add_action('init', function () {
    wp2_init_themes_templates_controller();
}, 30);
